...
const solutions = [
  ...
  },
  {
    ...
    logo: "/assets/logos/chatbots_logo.png",
  },
  {
    ...
    <Section className="gap-10">
      ...
      <ul className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {solutions.map((s) => {
          ...
          if (s.slug === "consensus-engine") priceLine = `${formatMoney(PRICING.consensusEngine.monthly)}/mo for up to ${PRICING.consensusEngine.queryLimit} queries. Includes one free report with consultation.`;
          if (s.slug === "redbridging") priceLine = `From ${formatMoney(PRICING.redbridging.standaloneLow)}/mo standalone or free with Flowstack™/Cadence™`;
          return (
