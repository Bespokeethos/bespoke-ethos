  ...
  return (
    <Section className="gap-6">
      ...
      <div className="space-y-4 text-text-secondary">
        <p>
          When I was drowning in my publishing business, I didn&rsquo;t need a fancy AI platform. I needed someone to automate the one task that was stealing hours from my week. So I built Flowstack™™ for myself first. It is our proprietary general automation package, designed to handle any business task—from lead routing to inventory updates.
        </p>
        <p>
          We map your real process, keep human approvals intact, and ship a production-ready automation in days. Every build ships with documentation, audit trails, and rollback—because I learned the hard way that automation without guardrails creates more problems than it solves.
        </p>
      </div>
