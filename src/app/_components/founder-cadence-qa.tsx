export function FounderCadenceQA() {
  const items: { q: string; a: string }[] = [
    {
      q: "Why did you build Cadence™?",
      a: "Because I hate bad chatbots as much as you do. I've run small businesses long enough to know what it feels like when a \"helpful\" widget makes customers more frustrated, not less. Cadence™ came out of a simple question: what if a chatbot could sound like your best day on the floor with a regular instead of a script someone copied out of a support playbook?"
    },
    {
      q: "What makes Cadence™ worth $900+ and a monthly fee?",
      a: "You're not buying a plugin-you're buying a teammate that pays rent. We sit in your world, study your products and stories, and train Cadence™ to handle the questions you answer 50 times a week and tell the stories that actually close the sale. The conditional patent we've been granted on the orchestration behind Cadence™ isn't a flex for lawyers; it's proof there's real process and IP behind how we keep answers on-brand, safe, and measurable. I know that makes Cadence™ feel expensive-and I also know it's underpriced for the kind of lifetime value it can unlock when it's tuned properly."
    },
    {
      q: "Is Cadence™ just ChatGPT with a skin on it?",
      a: "No. Under the hood we absolutely use modern AI models-but Cadence™ is about everything wrapped around them: how we feed in your stories, how we set guardrails and approvals, how we monitor what it says, and how we decide when a human should step in. Think of the model as the engine; Cadence™ is the whole car, safety features included."
    },
    {
