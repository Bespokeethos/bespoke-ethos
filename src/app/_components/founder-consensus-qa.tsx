export function FounderConsensusQA() {
  const items: { q: string; a: string }[] = [
    {
      q: "Why did you build AI Research Assistant?",
    ...
    },
    {
      ...
      a: "Yes. I keep one standing grant each year for up to four AI Research Assistant research queries. It’s reserved for founders and organizations who genuinely need this level of clarity but can’t reasonably fit it into the budget right now. There’s no fancy application—just email me, tell me what you need my tech for, and if I think we’re a fit, we’ll make it happen. I know this level of research doesn’t come cheap—and I also know it’s underpriced for what it can do when you point it at the right questions."
    }
  ];
