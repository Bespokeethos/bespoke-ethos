...
```toml
model = "gpt-5.1"  # overrides the default (Codex subscriber default: "gpt-5.1")
```

> [!TIP]
> Use `/model` inside Codex to swap between the standard subscriber stack (`gpt-5.1`, `gpt-4.1`, `gpt-4o`) mid-session without editing files.
...
| ------------------------------------------------ | ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `model`                                          | string                                                            | Model to use (e.g., `gpt-5.1`).                                                                                             |
